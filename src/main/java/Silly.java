...
public class Silly implements Comparable<Silly>{
     ...
     *
     * @param firstString the first string to be concatenated on the left hand side
     * @param secondString the second string to be concatenated on the right hand side
     */
